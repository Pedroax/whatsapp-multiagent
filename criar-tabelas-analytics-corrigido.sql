-- ============================================================================
-- TABELAS DE ANALYTICS - Alice LC Baterias
-- ============================================================================
...
-- Índices para performance
CREATE INDEX IF NOT EXISTS idx_leads_pendentes_telefone ON leads_pendentes(telefone);
...
CREATE TRIGGER trigger_leads_pendentes_updated_at
    BEFORE UPDATE ON leads_pendentes
    FOR EACH ROW
    EXECUTE FUNCTION atualizar_updated_at();

-- Comentários
COMMENT ON TABLE pedidos IS 'Pedidos confirmados pela IA para analytics e relatórios';
