...
-- ============================================================================
-- PARTE 1: CRIAR DEPARTAMENTOS (apenas os que faltam)
-- ============================================================================

-- Vendas (já existe)
-- Financeiro (já existe)
-- Suporte (já existe)
-- Assistência (já existe)
...
-- VERIFICAR
SELECT email, nome_completo, role, departamento_slug FROM usuarios WHERE empresa_id = 'emp1';
